...
# with command line options: step1 --filein file:AODSIM_step2.root --fileout file:MiniAODv2.root --mc --eventcontent MINIAODSIM --runUnscheduled --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --conditions 74X_mcRun2_asymptotic_v2 --step PAT --python_filename MiniAODv2_cfg.py --no_exec -n 2000
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:AODSIM_step2.root'),
